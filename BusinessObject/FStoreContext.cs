...
namespace BusinessObject
{
    public partial class FStoreContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                //optionsBuilder.UseSqlServer(eStoreLibrary.eStoreApiConfiguration.ConnectionString);
                optionsBuilder.UseSqlServer("Server=TRANPHONG\\SQLEXPRESS;uid=sa;pwd=1234567890;database=FStoreDB");
            }
        }
